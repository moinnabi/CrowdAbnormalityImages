function [wt,td,E] = plsa(counts,T,epsilon,plo,wt,learn)
%
...
%
% wt      (W x T)  : word-topic distributions
% td      (T x D)  : topic-document distributions
% E	  (1 x D)  : document log-likelihood: log p( words in doc | doc )
%
% J.J. Verbeek, INIRA Rhone-Alpes, 2006.
%
