#!/bin/sh
export LIB_GCC=/usr/local/lib/gcc/x86_64-apple-darwin13.2.0/4.8.3/
export DYLD_LIBRARY_PATH=$DYLD_LIBRARY_PATH:/usr/local/lib/gcc/x86_64-apple-darwin13.2.0/4.8.3/:/
